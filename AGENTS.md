...
- Framework: DPDK
- Build: CMake
- Target: Linux (Ericsson L1 Simulator)
...
### Layout
- src/: Source files
- include/dpdk_fast_switch/: Headers

### Conventions
- Use MISRA-C guidelines.
- High performance DPDK data plane programming.

## 11. Project Learnings
- Ensure proper rte_mbuf lifecycle management.
